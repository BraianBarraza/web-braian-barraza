...
const Hero = ({assetsBase, isLight}) => {
    ...
    return (
        <section id="home" className="section-wrap min-h-screen pt-28">
            <div
                className="grid min-h-[calc(100vh-7rem)] items-center gap-12 py-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
                <div>
                ...
                <div className="relative mx-auto w-full max-w-[25rem] lg:max-w-[30rem]">
                    <div
                        className="glass relative overflow-hidden rounded-lg p-6 shadow-[0_30px_80px_rgba(0,0,0,0.28)]">
                        <div
                            className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-cyan-300 via-violet-500 to-transparent"></div>
                        <img
                            src={heroImage}
                        ...
                        />
                        <div
                            className="glass-strong absolute bottom-5 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-lg px-4 py-2 font-display text-sm font-bold text-cyan-200">
                    ...
                    <div
                        className="glass absolute -right-4 top-8 rounded-lg px-4 py-2 font-display text-sm font-bold text-cyan-200">
                        React
                    </div>
                    <div
                        className="glass absolute -left-4 bottom-16 rounded-lg px-4 py-2 font-display text-sm font-bold text-lime-200">
                        Tailwind
                    </div>
                </div>
            </div>
